...
npm install
```
4. Don't forget to fill out the `botToken`, `boostAnnounceChannelId` and `boostLogsChannelId` in [`config.json`](https://github.com/Masihdeveloper/Boost-Unboost-Announcer/blob/main/config.json) file by your real information! 
